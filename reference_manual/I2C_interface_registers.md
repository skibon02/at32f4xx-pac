...
| Bit 3 | ADDRHF   | 0x0 | r    | 0\~7 bit address head match flag<br/>0: 0\~7 bit address head mismatch<br/>1: 0\~7 bit address head match                                                                                                                                                                                                                                                                                           |
...
| Bit 0 | TDBE     | 0x1 | rw1s | Transmit data buffer empty flag<br/>0: I2C\_TXDT not empty<br/>1: I2C\_TXDT empty<br/>This bit is only used to indicate the current status of the I2C\_TXDT register. The I2C\_TXDT register can be cleared by writing 1 through software.                                                                                                                                                          |
