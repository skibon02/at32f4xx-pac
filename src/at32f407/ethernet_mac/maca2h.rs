...
pub type MA2H_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16, crate::Safe>;
...
#[doc = "Ethernet MAC address 2 high register\n\nYou can [`read`](crate::Reg::read) this register and get [`maca2h::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`maca2h::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
