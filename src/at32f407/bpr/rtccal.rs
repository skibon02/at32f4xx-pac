...
pub type CCOS_R = crate::BitReader;
#[doc = "Field `CCOS` writer - Calibration clock output selection"]
pub type CCOS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn ccos(&self) -> CCOS_R {
        CCOS_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - Output mode"]
    #[inline(always)]
    pub fn outm(&self) -> OUTM_R {
        OUTM_R::new(((self.bits >> 11) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RTCCAL")
            ...
            .field("ccos", &self.ccos())
            .field("outm", &self.outm())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 10 - Calibration clock output selection"]
    #[inline(always)]
    pub fn ccos(&mut self) -> CCOS_W<'_, RTCCAL_SPEC> {
        CCOS_W::new(self, 10)
    }
    #[doc = "Bit 11 - Output mode"]
    #[inline(always)]
    pub fn outm(&mut self) -> OUTM_W<'_, RTCCAL_SPEC> {
        OUTM_W::new(self, 11)
    }
}
