...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            ...
            USART7: unsafe { USART7::steal() },
            USART8: unsafe { USART8::steal() },
            CRC: unsafe { CRC::steal() },
            FLASH: unsafe { FLASH::steal() },
            USB_OTGFS_GLOBAL: unsafe { USB_OTGFS_GLOBAL::steal() },
            USB_OTGFS_HOST: unsafe { USB_OTGFS_HOST::steal() },
            USB_OTGFS_DEVICE: unsafe { USB_OTGFS_DEVICE::steal() },
            USB_OTGFS_PWRCLK: unsafe { USB_OTGFS_PWRCLK::steal() },
