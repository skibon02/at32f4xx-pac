...
pub enum PLL_REFERENCE_CLOCK_SELECT_A {
    #[doc = "0: HICK clock selected as PLL reference clock"]
    Hick = 0,
    #[doc = "1: HEXT clock selected as PLL reference clock"]
    Hext = 1,
}
...
impl PLLRCS_R {
    ...
    #[doc = "HICK clock selected as PLL reference clock"]
    #[inline(always)]
    pub fn is_hick(&self) -> bool {
        *self == PLL_REFERENCE_CLOCK_SELECT_A::Hick
    }
    #[doc = "HEXT clock selected as PLL reference clock"]
    #[inline(always)]
