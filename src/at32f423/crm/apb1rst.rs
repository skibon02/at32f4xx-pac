...
#[doc = "Field `USART7` reader - USART7 reset"]
pub use TMR2_R as USART7_R;
#[doc = "Field `USART8` reader - USART8 reset"]
...
#[doc = "Field `USART7` writer - USART7 reset"]
pub use TMR2_W as USART7_W;
#[doc = "Field `USART8` writer - USART8 reset"]
...
impl W {
    ...
    #[doc = "Bit 4 - Timer6 reset"]
    #[inline(always)]
    pub fn tmr6(&mut self) -> TMR6_W<'_, APB1RST_SPEC> {
        TMR6_W::new(self, 4)
    }
    #[doc = "Bit 5 - Timer7 reset"]
    #[inline(always)]
    pub fn tmr7(&mut self) -> TMR7_W<'_, APB1RST_SPEC> {
        TMR7_W::new(self, 5)
    }
    #[doc = "Bit 6 - Timer12 reset"]
    #[inline(always)]
    pub fn tmr12(&mut self) -> TMR12_W<'_, APB1RST_SPEC> {
        TMR12_W::new(self, 6)
    }
    #[doc = "Bit 7 - Timer13 reset"]
    #[inline(always)]
    pub fn tmr13(&mut self) -> TMR13_W<'_, APB1RST_SPEC> {
        TMR13_W::new(self, 7)
    }
    #[doc = "Bit 8 - Timer14 reset"]
    #[inline(always)]
    pub fn tmr14(&mut self) -> TMR14_W<'_, APB1RST_SPEC> {
        TMR14_W::new(self, 8)
    }
    #[doc = "Bit 11 - Window watchdog reset"]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - SPI3 reset"]
    #[inline(always)]
    pub fn spi3(&mut self) -> SPI3_W<'_, APB1RST_SPEC> {
        SPI3_W::new(self, 15)
    }
    #[doc = "Bit 17 - USART2 reset"]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - USART4 reset"]
    #[inline(always)]
    pub fn usart4(&mut self) -> USART4_W<'_, APB1RST_SPEC> {
        USART4_W::new(self, 19)
    }
    #[doc = "Bit 20 - USART5 reset"]
    #[inline(always)]
    pub fn usart5(&mut self) -> USART5_W<'_, APB1RST_SPEC> {
    ...
    #[doc = "Bit 23 - I2C3 reset"]
    #[inline(always)]
    pub fn i2c3(&mut self) -> I2C3_W<'_, APB1RST_SPEC> {
        I2C3_W::new(self, 23)
    }
    #[doc = "Bit 25 - CAN1 reset"]
    #[inline(always)]
    ...
    #[doc = "Bit 29 - DAC reset"]
    #[inline(always)]
    pub fn dac(&mut self) -> DAC_W<'_, APB1RST_SPEC> {
        DAC_W::new(self, 29)
    }
    #[doc = "Bit 30 - USART7 reset"]
    #[inline(always)]
    pub fn usart7(&mut self) -> USART7_W<'_, APB1RST_SPEC> {
        USART7_W::new(self, 30)
    }
    #[doc = "Bit 31 - USART8 reset"]
    #[inline(always)]
    pub fn usart8(&mut self) -> USART8_W<'_, APB1RST_SPEC> {
...
impl crate::Writable for APB1RST_SPEC {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0xf6fe_c9f7;
}
