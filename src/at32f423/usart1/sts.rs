...
#[doc = "Field `RTODF` reader - Receiver time out detection flag"]
pub type RTODF_R = crate::BitReader;
#[doc = "Field `OCCUPY` reader - Receiver occupied flag"]
pub type OCCUPY_R = crate::BitReader;
#[doc = "Field `CMDF` reader - Character match detect flag"]
pub type CMDF_R = crate::BitReader;
#[doc = "Field `LPWUF` reader - Low power wakeup flag"]
pub type LPWUF_R = crate::BitReader;
#[doc = "Field `TXON` reader - Transmitter enabled flag"]
pub type TXON_R = crate::BitReader;
#[doc = "Field `RXON` reader - Receiver enabled flag"]
pub type RXON_R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 11 - Receiver time out detection flag"]
    #[inline(always)]
    pub fn rtodf(&self) -> RTODF_R {
        RTODF_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 16 - Receiver occupied flag"]
    #[inline(always)]
    pub fn occupy(&self) -> OCCUPY_R {
        OCCUPY_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - Character match detect flag"]
    #[inline(always)]
    pub fn cmdf(&self) -> CMDF_R {
        CMDF_R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 20 - Low power wakeup flag"]
    #[inline(always)]
    pub fn lpwuf(&self) -> LPWUF_R {
        LPWUF_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - Transmitter enabled flag"]
    #[inline(always)]
    pub fn txon(&self) -> TXON_R {
        TXON_R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - Receiver enabled flag"]
    #[inline(always)]
    pub fn rxon(&self) -> RXON_R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STS")
            .field("rxon", &self.rxon())
            .field("txon", &self.txon())
            .field("lpwuf", &self.lpwuf())
            .field("cmdf", &self.cmdf())
            .field("occupy", &self.occupy())
