...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INTSTS")
            ...
            .field("line20", &self.line20())
            .field("line21", &self.line21())
            .field("line22", &self.line22())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 18 - Line 18 status bit"]
    #[inline(always)]
    pub fn line18(&mut self) -> LINE_W<'_, INTSTS_SPEC> {
        LINE_W::new(self, 18)
    }
    #[doc = "Bit 19 - Line 19 status bit"]
    #[inline(always)]
    pub fn line19(&mut self) -> LINE_W<'_, INTSTS_SPEC> {
        LINE_W::new(self, 19)
    }
    #[doc = "Bit 20 - Line 20 status bit"]
    #[inline(always)]
    pub fn line20(&mut self) -> LINE_W<'_, INTSTS_SPEC> {
        LINE_W::new(self, 20)
    }
    #[doc = "Bit 21 - Line 21 status bit"]
    #[inline(always)]
    pub fn line21(&mut self) -> LINE_W<'_, INTSTS_SPEC> {
        LINE_W::new(self, 21)
    }
    #[doc = "Bit 22 - Line 22 status bit"]
    #[inline(always)]
    pub fn line22(&mut self) -> LINE_W<'_, INTSTS_SPEC> {
        LINE_W::new(self, 22)
    }
}
