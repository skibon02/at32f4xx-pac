...
#[doc = "User system data program\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Usdprgmr {
    #[doc = "0: User system data program operation not started"]
    NotStarted = 0,
    #[doc = "1: User system data program operation is in progress"]
    Started = 1,
}
impl From<Usdprgmr> for bool {
    #[inline(always)]
    fn from(variant: Usdprgmr) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `USDPRGM` reader - User system data program"]
pub type USDPRGM_R = crate::BitReader<Usdprgmr>;
impl USDPRGM_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Usdprgmr {
        match self.bits {
            false => Usdprgmr::NotStarted,
            true => Usdprgmr::Started,
        }
    }
    #[doc = "User system data program operation not started"]
    #[inline(always)]
    pub fn is_not_started(&self) -> bool {
        *self == Usdprgmr::NotStarted
    }
    #[doc = "User system data program operation is in progress"]
    #[inline(always)]
    pub fn is_started(&self) -> bool {
        *self == Usdprgmr::Started
    }
}
#[doc = "User system data program\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
...
pub enum UsdprgmwWO {
    #[doc = "0: User system data program operation not started"]
    NoStart = 0,
    #[doc = "1: Start of user system data program operation"]
    Start = 1,
}
impl From<UsdprgmwWO> for bool {
    #[inline(always)]
    fn from(variant: UsdprgmwWO) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `USDPRGM` writer - User system data program"]
pub type USDPRGM_W<'a, REG> = crate::BitWriter<'a, REG, UsdprgmwWO>;
impl<'a, REG> USDPRGM_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "User system data program operation not started"]
    #[inline(always)]
    pub fn no_start(self) -> &'a mut crate::W<REG> {
        self.variant(UsdprgmwWO::NoStart)
    }
    #[doc = "Start of user system data program operation"]
    #[inline(always)]
    pub fn start(self) -> &'a mut crate::W<REG> {
        self.variant(UsdprgmwWO::Start)
    }
}
#[doc = "User system data erase\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Usdersr {
    #[doc = "0: User system data erase operation not started"]
    NotStarted = 0,
    #[doc = "1: User system data erase operation is in progress"]
    Started = 1,
}
impl From<Usdersr> for bool {
    #[inline(always)]
    fn from(variant: Usdersr) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `USDERS` reader - User system data erase"]
pub type USDERS_R = crate::BitReader<Usdersr>;
impl USDERS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Usdersr {
        match self.bits {
            false => Usdersr::NotStarted,
            true => Usdersr::Started,
        }
    }
    #[doc = "User system data erase operation not started"]
    #[inline(always)]
    pub fn is_not_started(&self) -> bool {
        *self == Usdersr::NotStarted
    }
    #[doc = "User system data erase operation is in progress"]
    #[inline(always)]
    pub fn is_started(&self) -> bool {
        *self == Usdersr::Started
    }
}
#[doc = "User system data erase\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
...
pub enum UsderswWO {
    #[doc = "0: User system data erase operation not started"]
    NoStart = 0,
    #[doc = "1: Start of user system data erase operation"]
    Start = 1,
}
impl From<UsderswWO> for bool {
    #[inline(always)]
    fn from(variant: UsderswWO) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `USDERS` writer - User system data erase"]
pub type USDERS_W<'a, REG> = crate::BitWriter<'a, REG, UsderswWO>;
impl<'a, REG> USDERS_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "User system data erase operation not started"]
    #[inline(always)]
    pub fn no_start(self) -> &'a mut crate::W<REG> {
        self.variant(UsderswWO::NoStart)
    }
    #[doc = "Start of user system data erase operation"]
    #[inline(always)]
    pub fn start(self) -> &'a mut crate::W<REG> {
        self.variant(UsderswWO::Start)
    }
}
#[doc = "Erasing start\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
...
#[doc = "User system data unlock success\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Usdulksr {
...
impl From<Usdulksr> for bool {
    #[inline(always)]
    fn from(variant: Usdulksr) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `USDULKS` reader - User system data unlock success"]
pub type USDULKS_R = crate::BitReader<Usdulksr>;
impl USDULKS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Usdulksr {
        match self.bits {
            false => Usdulksr::Locked,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum UsdulkswWO {
    #[doc = "0: Lock user system data"]
    Relock = 0,
}
impl From<UsdulkswWO> for bool {
    #[inline(always)]
    fn from(variant: UsdulkswWO) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `USDULKS` writer - User system data unlock success"]
pub type USDULKS_W<'a, REG> = crate::BitWriter<'a, REG, UsdulkswWO>;
impl<'a, REG> USDULKS_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Lock user system data"]
    #[inline(always)]
    pub fn relock(self) -> &'a mut crate::W<REG> {
        self.variant(UsdulkswWO::Relock)
    }
}
...
impl W {
    #[doc = "Bit 0 - Flash program"]
    #[inline(always)]
    pub fn fprgm(&mut self) -> FPRGM_W<'_, CTRL1_SPEC> {
        FPRGM_W::new(self, 0)
    }
    #[doc = "Bit 1 - Sector erase"]
    #[inline(always)]
    pub fn secers(&mut self) -> SECERS_W<'_, CTRL1_SPEC> {
        SECERS_W::new(self, 1)
    }
    #[doc = "Bit 2 - Bank erase"]
    #[inline(always)]
    pub fn bankers(&mut self) -> BANKERS_W<'_, CTRL1_SPEC> {
        BANKERS_W::new(self, 2)
    }
    #[doc = "Bit 3 - Block erase"]
    #[inline(always)]
    pub fn blkers(&mut self) -> BLKERS_W<'_, CTRL1_SPEC> {
        BLKERS_W::new(self, 3)
    }
    #[doc = "Bit 4 - User system data program"]
    #[inline(always)]
    pub fn usdprgm(&mut self) -> USDPRGM_W<'_, CTRL1_SPEC> {
        USDPRGM_W::new(self, 4)
    }
    #[doc = "Bit 5 - User system data erase"]
    #[inline(always)]
    pub fn usders(&mut self) -> USDERS_W<'_, CTRL1_SPEC> {
        USDERS_W::new(self, 5)
    }
    #[doc = "Bit 6 - Erasing start"]
    #[inline(always)]
    pub fn erstr(&mut self) -> ERSTR_W<'_, CTRL1_SPEC> {
        ERSTR_W::new(self, 6)
    }
    #[doc = "Bit 7 - Operation lock"]
    #[inline(always)]
    pub fn oplk(&mut self) -> OPLK_W<'_, CTRL1_SPEC> {
        OPLK_W::new(self, 7)
    }
    #[doc = "Bit 9 - User system data unlock success"]
    #[inline(always)]
    pub fn usdulks(&mut self) -> USDULKS_W<'_, CTRL1_SPEC> {
        USDULKS_W::new(self, 9)
    }
    #[doc = "Bit 10 - Error interrupt enable"]
    #[inline(always)]
    pub fn errie(&mut self) -> ERRIE_W<'_, CTRL1_SPEC> {
        ERRIE_W::new(self, 10)
    }
    #[doc = "Bit 12 - Operation done flag interrupt enable"]
    #[inline(always)]
    pub fn odfie(&mut self) -> ODFIE_W<'_, CTRL1_SPEC> {
        ODFIE_W::new(self, 12)
    }
}
...
#[doc = "`reset()` method sets CTRL1 to value 0x80"]
