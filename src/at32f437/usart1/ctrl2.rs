...
pub type ID3_0_R = crate::FieldReader;
#[doc = "Field `ID3_0` writer - bit 3-0 for usart identification"]
pub type ID3_0_W<'a, REG> = crate::FieldWriter<'a, REG, 4, u8, crate::Safe>;
...
pub type ID7_4_R = crate::FieldReader;
#[doc = "Field `ID7_4` writer - bit 7-4 for usart identification"]
pub type ID7_4_W<'a, REG> = crate::FieldWriter<'a, REG, 4, u8, crate::Safe>;
impl R {
    #[doc = "Bits 0:3 - bit 3-0 for usart identification"]
    #[inline(always)]
    pub fn id3_0(&self) -> ID3_0_R {
        ID3_0_R::new((self.bits & 0x0f) as u8)
    }
    ...
    #[inline(always)]
    pub fn id7_4(&self) -> ID7_4_R {
        ID7_4_R::new(((self.bits >> 28) & 0x0f) as u8)
    }
}
...
impl W {
    #[doc = "Bits 0:3 - bit 3-0 for usart identification"]
    #[inline(always)]
    pub fn id3_0(&mut self) -> ID3_0_W<'_, CTRL2_SPEC> {
        ID3_0_W::new(self, 0)
    }
    #[doc = "Bit 4 - Identification bit num"]
    #[inline(always)]
    ...
    #[doc = "Bits 28:31 - bit 7-4 for usart identification"]
    #[inline(always)]
    pub fn id7_4(&mut self) -> ID7_4_W<'_, CTRL2_SPEC> {
        ID7_4_W::new(self, 28)
    }
}
