...
pub type PCTESEL_L_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
pub type OCTESEL_L_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
impl R {
    ...
    pub fn pctesel_l(&self) -> PCTESEL_L_R {
        PCTESEL_L_R::new(((self.bits >> 16) & 0x0f) as u8)
    }
