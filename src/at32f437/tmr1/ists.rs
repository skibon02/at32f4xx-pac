...
impl From<Trgifr> for bool {
    #[inline(always)]
    fn from(variant: Trgifr) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `TRGIF` reader - Trigger interrupt flag"]
pub type TRGIF_R = crate::BitReader<Trgifr>;
impl TRGIF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Trgifr {
        match self.bits {
            false => Trgifr::NoEvent,
            true => Trgifr::TriggerEvent,
        }
    }
...
impl From<TrgifwWO> for bool {
    #[inline(always)]
    fn from(variant: TrgifwWO) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `TRGIF` writer - Trigger interrupt flag"]
pub type TRGIF_W<'a, REG> = crate::BitWriter0C<'a, REG, TrgifwWO>;
impl<'a, REG> TRGIF_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
...
impl R {
    ...
    pub fn cif_iter(&self) -> impl Iterator<Item = CIF_R> + '_ {
        (0..4).map(move |n| CIF_R::new(((self.bits >> (n + 1)) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn c3if(&self) -> CIF_R {
        CIF_R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    pub fn crf_iter(&self) -> impl Iterator<Item = CRF_R> + '_ {
        (0..4).map(move |n| CRF_R::new(((self.bits >> (n + 9)) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn c3rf(&self) -> CRF_R {
        CRF_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - Channel 4 recapture flag"]
    #[inline(always)]
    pub fn c4rf(&self) -> CRF_R {
...
impl W {
    ...
    #[doc = "Bit 3 - Channel 3 interrupt flag"]
    #[inline(always)]
    pub fn c3if(&mut self) -> CIF_W<'_, ISTS_SPEC> {
        CIF_W::new(self, 3)
    }
    #[doc = "Bit 4 - Channel 4 interrupt flag"]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - Channel 3 recapture flag"]
    #[inline(always)]
    pub fn c3rf(&mut self) -> CRF_W<'_, ISTS_SPEC> {
        CRF_W::new(self, 11)
    }
    #[doc = "Bit 12 - Channel 4 recapture flag"]
    #[inline(always)]
    pub fn c4rf(&mut self) -> CRF_W<'_, ISTS_SPEC> {
        CRF_W::new(self, 12)
    }
}
