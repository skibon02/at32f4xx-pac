...
pub enum CLKOUT1DIV1_A {
    #[doc = "4: CLKOUT%s is divided by 2"]
    Div2 = 4,
    #[doc = "5: CLKOUT%s is divided by 3"]
    Div3 = 5,
    #[doc = "6: CLKOUT%s is divided by 4"]
    Div4 = 6,
    #[doc = "7: CLKOUT%s is divided by 5"]
    Div5 = 7,
