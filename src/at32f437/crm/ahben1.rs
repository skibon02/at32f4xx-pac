...
impl W {
    ...
    #[doc = "Bit 6 - IO G clock enable"]
    #[inline(always)]
    pub fn gpiog(&mut self) -> GPIOG_W<'_, AHBEN1_SPEC> {
        GPIOG_W::new(self, 6)
    }
    #[doc = "Bit 7 - IO H clock enable"]
    #[inline(always)]
    pub fn gpioh(&mut self) -> GPIOH_W<'_, AHBEN1_SPEC> {
        GPIOH_W::new(self, 7)
    }
    #[doc = "Bit 12 - CRC clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 21 - DMA1 clock enable"]
    #[inline(always)]
    pub fn edma(&mut self) -> EDMA_W<'_, AHBEN1_SPEC> {
        EDMA_W::new(self, 21)
    }
    #[doc = "Bit 22 - DMA1 clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 25 - EMAC clock enable"]
    #[inline(always)]
    pub fn emac(&mut self) -> EMAC_W<'_, AHBEN1_SPEC> {
        EMAC_W::new(self, 25)
    }
    #[doc = "Bit 26 - EMAC Tx clock enable"]
    #[inline(always)]
    pub fn emactx(&mut self) -> EMACTX_W<'_, AHBEN1_SPEC> {
        EMACTX_W::new(self, 26)
    }
    #[doc = "Bit 27 - EMAC Rx clock enable"]
    #[inline(always)]
    pub fn emacrx(&mut self) -> EMACRX_W<'_, AHBEN1_SPEC> {
        EMACRX_W::new(self, 27)
    }
    #[doc = "Bit 28 - EMAC PTP clock enable"]
    #[inline(always)]
    pub fn emacptp(&mut self) -> EMACPTP_W<'_, AHBEN1_SPEC> {
        EMACPTP_W::new(self, 28)
    }
    #[doc = "Bit 29 - OTGFS2 clock enable"]
    #[inline(always)]
    pub fn otgfs2(&mut self) -> OTGFS2_W<'_, AHBEN1_SPEC> {
