...
#[doc = "Clock output internal connect to timer10\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CLK_TO_TMR_A {
    #[doc = "0: Disconnected"]
    Disconnected = 0,
    #[doc = "1: CLKOUT1 internal connected to timer10 channel1"]
    Connected = 1,
}
impl From<CLK_TO_TMR_A> for bool {
    #[inline(always)]
    fn from(variant: CLK_TO_TMR_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `CLK_TO_TMR` reader - Clock output internal connect to timer10"]
pub type CLK_TO_TMR_R = crate::BitReader<CLK_TO_TMR_A>;
impl CLK_TO_TMR_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> CLK_TO_TMR_A {
        match self.bits {
            false => CLK_TO_TMR_A::Disconnected,
            true => CLK_TO_TMR_A::Connected,
        }
    }
    #[doc = "Disconnected"]
    #[inline(always)]
    pub fn is_disconnected(&self) -> bool {
        *self == CLK_TO_TMR_A::Disconnected
    }
    #[doc = "CLKOUT1 internal connected to timer10 channel1"]
    #[inline(always)]
    pub fn is_connected(&self) -> bool {
        *self == CLK_TO_TMR_A::Connected
    }
}
#[doc = "Field `CLK_TO_TMR` writer - Clock output internal connect to timer10"]
pub type CLK_TO_TMR_W<'a, REG> = crate::BitWriter<'a, REG, CLK_TO_TMR_A>;
impl<'a, REG> CLK_TO_TMR_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disconnected"]
    ...
    pub fn disconnected(self) -> &'a mut crate::W<REG> {
        self.variant(CLK_TO_TMR_A::Disconnected)
    }
    #[doc = "CLKOUT1 internal connected to timer10 channel1"]
    #[inline(always)]
    pub fn connected(self) -> &'a mut crate::W<REG> {
        self.variant(CLK_TO_TMR_A::Connected)
    }
}
#[doc = "USB division\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
