...
impl From<LDO_OUTPUT_VSELECT_A> for u8 {
    #[inline(always)]
    fn from(variant: LDO_OUTPUT_VSELECT_A) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for LDO_OUTPUT_VSELECT_A {
    type Ux = u8;
}
impl crate::IsEnum for LDO_OUTPUT_VSELECT_A {}
#[doc = "Field `LDOOVSEL` reader - LDO output voltage select"]
pub type LDOOVSEL_R = crate::FieldReader<LDO_OUTPUT_VSELECT_A>;
impl LDOOVSEL_R {
    ...
    pub fn is_v1_2(&self) -> bool {
        *self == LDO_OUTPUT_VSELECT_A::V1_2
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn v1_2(self) -> &'a mut crate::W<REG> {
        self.variant(LDO_OUTPUT_VSELECT_A::V1_2)
    }
    #[doc = "LDO output voltage is 1.3 V"]
    #[inline(always)]
