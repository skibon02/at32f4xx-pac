...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn tmr5_rmp(&self) -> &TMR5_RMP {
        &self.tmr5_rmp
    }
}
...
pub mod dmadt;
#[doc = "TMR5_RMP (rw) register accessor: TMR5 channel input remap register\n\nYou can [`read`](crate::Reg::read) this register and get [`tmr5_rmp::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tmr5_rmp::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@tmr5_rmp`] module"]
pub type TMR5_RMP = crate::Reg<tmr5_rmp::TMR5_RMP_SPEC>;
