...
#[doc = "Field `TMR8` reader - Timer8 clock enable during sleep mode"]
pub use TMR1_R as TMR8_R;
...
#[doc = "Field `TMR20` reader - Timer20 clock enable during sleep mode"]
pub use TMR1_R as TMR20_R;
#[doc = "Field `ACC` reader - ACC clock enable during sleep mode"]
pub use TMR1_R as ACC_R;
#[doc = "Field `TMR8` writer - Timer8 clock enable during sleep mode"]
pub use TMR1_W as TMR8_W;
...
#[doc = "Field `TMR20` writer - Timer20 clock enable during sleep mode"]
pub use TMR1_W as TMR20_W;
...
impl W {
    ...
    #[doc = "Bit 1 - Timer8 clock enable during sleep mode"]
    #[inline(always)]
    pub fn tmr8(&mut self) -> TMR8_W<'_, APB2LPEN_SPEC> {
        TMR8_W::new(self, 1)
    }
    #[doc = "Bit 4 - USART1 clock enable during sleep mode"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - ADC1 clock enable during sleep mode"]
    #[inline(always)]
    pub fn adc1cpen(&mut self) -> ADC1CPEN_W<'_, APB2LPEN_SPEC> {
        ADC1CPEN_W::new(self, 8)
    }
    #[doc = "Bit 9 - ADC2 clock enable during sleep mode"]
    #[inline(always)]
    pub fn adc2cpen(&mut self) -> ADC2CPEN_W<'_, APB2LPEN_SPEC> {
        ADC2CPEN_W::new(self, 9)
    }
    #[doc = "Bit 10 - ADC3 clock enable during sleep mode"]
    #[inline(always)]
    pub fn adc3en(&mut self) -> ADC3EN_W<'_, APB2LPEN_SPEC> {
    ...
    #[doc = "Bit 13 - SPI4 clock enable during sleep mode"]
    #[inline(always)]
    pub fn spi4(&mut self) -> SPI4_W<'_, APB2LPEN_SPEC> {
        SPI4_W::new(self, 13)
    }
    #[doc = "Bit 14 - SCFG clock enable during sleep mode"]
    #[inline(always)]
    ...
    #[doc = "Bit 20 - Timer20 clock enable during sleep mode"]
    #[inline(always)]
    pub fn tmr20(&mut self) -> TMR20_W<'_, APB2LPEN_SPEC> {
        TMR20_W::new(self, 20)
    }
    #[doc = "Bit 29 - ACC clock enable during sleep mode"]
    #[inline(always)]
