...
impl TMR2_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> TMR2_A {
        match self.bits {
            false => TMR2_A::Disable,
            true => TMR2_A::Enable,
        }
    }
...
pub type TMR2_W<'a, REG> = crate::BitWriter<'a, REG, TMR2_A>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn disable(self) -> &'a mut crate::W<REG> {
        self.variant(TMR2_A::Disable)
    }
    #[doc = "Enable peripheral clock"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut crate::W<REG> {
        self.variant(TMR2_A::Enable)
    }
}
...
impl W {
    ...
    #[doc = "Bit 2 - Timer4 clock enable"]
    #[inline(always)]
    pub fn tmr4(&mut self) -> TMR4_W<'_, APB1EN_SPEC> {
        TMR4_W::new(self, 2)
    }
    #[doc = "Bit 3 - Timer5 clock enable"]
    #[inline(always)]
    pub fn tmr5(&mut self) -> TMR5_W<'_, APB1EN_SPEC> {
        TMR5_W::new(self, 3)
    }
    #[doc = "Bit 4 - Timer6 clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - Timer12 clock enable"]
    #[inline(always)]
    pub fn tmr12(&mut self) -> TMR12_W<'_, APB1EN_SPEC> {
        TMR12_W::new(self, 6)
    }
    #[doc = "Bit 7 - Timer13 clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - UART4 clock enable"]
    #[inline(always)]
    pub fn uart4(&mut self) -> UART4_W<'_, APB1EN_SPEC> {
        UART4_W::new(self, 19)
    }
    #[doc = "Bit 20 - UART5 clock enable"]
    #[inline(always)]
    pub fn uart5(&mut self) -> UART5_W<'_, APB1EN_SPEC> {
        UART5_W::new(self, 20)
    }
    #[doc = "Bit 21 - I2C1 clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 23 - I2C3 clock enable"]
    #[inline(always)]
    pub fn i2c3(&mut self) -> I2C3_W<'_, APB1EN_SPEC> {
        I2C3_W::new(self, 23)
    }
    #[doc = "Bit 25 - CAN1 clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 26 - CAN2 clock enable"]
    #[inline(always)]
    pub fn can2(&mut self) -> CAN2_W<'_, APB1EN_SPEC> {
        CAN2_W::new(self, 26)
    }
    #[doc = "Bit 28 - PWC clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 29 - DAC clock enable"]
    #[inline(always)]
    pub fn dac(&mut self) -> DAC_W<'_, APB1EN_SPEC> {
        DAC_W::new(self, 29)
    }
    #[doc = "Bit 30 - UART7 clock enable"]
    #[inline(always)]
    pub fn uart7(&mut self) -> UART7_W<'_, APB1EN_SPEC> {
        UART7_W::new(self, 30)
    }
    #[doc = "Bit 31 - UART8 clock enable"]
    #[inline(always)]
    pub fn uart8(&mut self) -> UART8_W<'_, APB1EN_SPEC> {
        UART8_W::new(self, 31)
    }
}
