...
#[doc = "Field `TMR5` reader - Timer5 clock enable during sleep mode"]
...
#[doc = "Field `UART4` reader - UART4 clock enable during sleep mode"]
pub use TMR2_R as UART4_R;
#[doc = "Field `UART5` reader - UART5 clock enable during sleep mode"]
...
#[doc = "Field `UART7` reader - UART7 clock enable during sleep mode"]
pub use TMR2_R as UART7_R;
#[doc = "Field `UART8` reader - UART8 clock enable during sleep mode"]
...
#[doc = "Field `TMR5` writer - Timer5 clock enable during sleep mode"]
...
#[doc = "Field `UART4` writer - UART4 clock enable during sleep mode"]
pub use TMR2_W as UART4_W;
#[doc = "Field `UART5` writer - UART5 clock enable during sleep mode"]
...
#[doc = "Field `UART7` writer - UART7 clock enable during sleep mode"]
pub use TMR2_W as UART7_W;
#[doc = "Field `UART8` writer - UART8 clock enable during sleep mode"]
...
impl W {
    ...
    #[doc = "Bit 3 - Timer5 clock enable during sleep mode"]
    #[inline(always)]
    pub fn tmr5(&mut self) -> TMR5_W<'_, APB1LPEN_SPEC> {
        TMR5_W::new(self, 3)
    }
    #[doc = "Bit 4 - Timer6 clock enable during sleep mode"]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - UART4 clock enable during sleep mode"]
    #[inline(always)]
    pub fn uart4(&mut self) -> UART4_W<'_, APB1LPEN_SPEC> {
        UART4_W::new(self, 19)
    }
    #[doc = "Bit 20 - UART5 clock enable during sleep mode"]
    #[inline(always)]
    pub fn uart5(&mut self) -> UART5_W<'_, APB1LPEN_SPEC> {
        UART5_W::new(self, 20)
    }
    #[doc = "Bit 21 - I2C1 clock enable during sleep mode"]
    #[inline(always)]
    ...
    #[doc = "Bit 30 - UART7 clock enable during sleep mode"]
    #[inline(always)]
    pub fn uart7(&mut self) -> UART7_W<'_, APB1LPEN_SPEC> {
        UART7_W::new(self, 30)
    }
    #[doc = "Bit 31 - UART8 clock enable during sleep mode"]
    #[inline(always)]
    pub fn uart8(&mut self) -> UART8_W<'_, APB1LPEN_SPEC> {
        UART8_W::new(self, 31)
    }
}
