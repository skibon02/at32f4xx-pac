...
pub use TMR1_R as ADC2_R;
#[doc = "Field `ADC3` reader - ADC3 clock enable"]
pub use TMR1_R as ADC3_R;
...
pub use TMR1_W as ADC2_W;
#[doc = "Field `ADC3` writer - ADC3 clock enable"]
pub use TMR1_W as ADC3_W;
...
impl W {
    ...
    #[doc = "Bit 13 - SPI4 clock enable"]
    #[inline(always)]
    pub fn spi4(&mut self) -> SPI4_W<'_, APB2EN_SPEC> {
        SPI4_W::new(self, 13)
    }
    #[doc = "Bit 14 - SCFG clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 20 - Timer20 clock enable"]
    #[inline(always)]
    pub fn tmr20(&mut self) -> TMR20_W<'_, APB2EN_SPEC> {
        TMR20_W::new(self, 20)
    }
    #[doc = "Bit 29 - ACC clock enable"]
    #[inline(always)]
