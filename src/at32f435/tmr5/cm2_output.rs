...
pub type C3OIEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type C3OBEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type C3OCTRL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type C3OSEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type C4OIEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type C4OBEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type C4OCTRL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type C4OSEN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 2 - Channel 3 output immediately enable"]
    #[inline(always)]
    pub fn c3oien(&mut self) -> C3OIEN_W<'_, CM2_OUTPUT_SPEC> {
        C3OIEN_W::new(self, 2)
    }
    #[doc = "Bit 3 - Channel 3 output buffer enable"]
    #[inline(always)]
    pub fn c3oben(&mut self) -> C3OBEN_W<'_, CM2_OUTPUT_SPEC> {
        C3OBEN_W::new(self, 3)
    }
    #[doc = "Bits 4:6 - Channel 3 output control"]
    #[inline(always)]
    pub fn c3octrl(&mut self) -> C3OCTRL_W<'_, CM2_OUTPUT_SPEC> {
        C3OCTRL_W::new(self, 4)
    }
    #[doc = "Bit 7 - Channel 3 output switch enable"]
    #[inline(always)]
    pub fn c3osen(&mut self) -> C3OSEN_W<'_, CM2_OUTPUT_SPEC> {
        C3OSEN_W::new(self, 7)
    }
    #[doc = "Bits 8:9 - Channel 4 configure"]
    #[inline(always)]
    ...
    #[doc = "Bit 10 - Channel 4 output immediately enable"]
    #[inline(always)]
    pub fn c4oien(&mut self) -> C4OIEN_W<'_, CM2_OUTPUT_SPEC> {
        C4OIEN_W::new(self, 10)
    }
    #[doc = "Bit 11 - Channel 4 output buffer enable"]
    #[inline(always)]
    pub fn c4oben(&mut self) -> C4OBEN_W<'_, CM2_OUTPUT_SPEC> {
        C4OBEN_W::new(self, 11)
    }
    #[doc = "Bits 12:14 - Channel 4 output control"]
    #[inline(always)]
    pub fn c4octrl(&mut self) -> C4OCTRL_W<'_, CM2_OUTPUT_SPEC> {
        C4OCTRL_W::new(self, 12)
    }
    #[doc = "Bit 15 - Channel 4 output switch enable"]
    #[inline(always)]
    pub fn c4osen(&mut self) -> C4OSEN_W<'_, CM2_OUTPUT_SPEC> {
        C4OSEN_W::new(self, 15)
    }
}
