...
#[doc = "Coarse calibration enable\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Ccalenr {
    #[doc = "0: Coarse calibration is disabled"]
    Disabled = 0,
    #[doc = "1: Coarse calibration is enabled"]
    Enabled = 1,
}
impl From<Ccalenr> for bool {
    #[inline(always)]
    fn from(variant: Ccalenr) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `CCALEN` reader - Coarse calibration enable"]
pub type CCALEN_R = crate::BitReader<Ccalenr>;
impl CCALEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Ccalenr {
        match self.bits {
            false => Ccalenr::Disabled,
            true => Ccalenr::Enabled,
        }
    }
    #[doc = "Coarse calibration is disabled"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == Ccalenr::Disabled
    }
    #[doc = "Coarse calibration is enabled"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CcalenwWO {
    #[doc = "0: Coarse calibration disable"]
    Disable = 0,
    #[doc = "1: Coarse calibration enable"]
    Enable = 1,
}
impl From<CcalenwWO> for bool {
    #[inline(always)]
    fn from(variant: CcalenwWO) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `CCALEN` writer - Coarse calibration enable"]
pub type CCALEN_W<'a, REG> = crate::BitWriter<'a, REG, CcalenwWO>;
impl<'a, REG> CCALEN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Coarse calibration disable"]
    #[inline(always)]
    pub fn disable(self) -> &'a mut crate::W<REG> {
        self.variant(CcalenwWO::Disable)
    }
    #[doc = "Coarse calibration enable"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut crate::W<REG> {
        self.variant(CcalenwWO::Enable)
    }
}
#[doc = "Alarm A enable\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
