...
impl From<PIN_SELECTION_A> for bool {
    #[inline(always)]
    fn from(variant: PIN_SELECTION_A) -> Self {
        variant as u8 != 0
    }
}
...
impl TSPIN_R {
    ...
    pub const fn variant(&self) -> PIN_SELECTION_A {
        match self.bits {
            false => PIN_SELECTION_A::ErtcMux1,
            true => PIN_SELECTION_A::ErtcMux2,
        }
    }
    #[doc = "ERTC_MUX1"]
    #[inline(always)]
    pub fn is_ertc_mux1(&self) -> bool {
        *self == PIN_SELECTION_A::ErtcMux1
    }
    #[doc = "ERTC_MUX2"]
    #[inline(always)]
    pub fn is_ertc_mux2(&self) -> bool {
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "ERTC_MUX1"]
    #[inline(always)]
    pub fn ertc_mux1(self) -> &'a mut crate::W<REG> {
        self.variant(PIN_SELECTION_A::ErtcMux1)
    }
    #[doc = "ERTC_MUX2"]
    #[inline(always)]
    pub fn ertc_mux2(self) -> &'a mut crate::W<REG> {
