...
pub type OCMEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OWCDIR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TWCMSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl W {
    ...
    #[doc = "Bit 4 - One-way count direction"]
    #[inline(always)]
    pub fn owcdir(&mut self) -> OWCDIR_W<'_, CTRL1_SPEC> {
        OWCDIR_W::new(self, 4)
    }
    #[doc = "Bits 5:6 - Two-way count mode selection"]
    #[inline(always)]
    pub fn twcmsel(&mut self) -> TWCMSEL_W<'_, CTRL1_SPEC> {
