...
#[doc = "Field `I2S5CLKSEL` writer - I2S clock select"]
pub type I2S5CLKSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl R {
    ...
    #[inline(always)]
    pub fn i2s5clksel(&self) -> I2S5CLKSEL_R {
        I2S5CLKSEL_R::new(((self.bits >> 22) & 3) as u8)
    }
