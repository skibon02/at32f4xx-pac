...
impl R {
    ...
    #[inline(always)]
    pub fn retodie(&self) -> RETODIE_R {
        RETODIE_R::new(((self.bits >> 26) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 14 - Character match detection interrupt enable"]
    #[inline(always)]
    pub fn cmdie(&mut self) -> CMDIE_W<'_, CTRL1_SPEC> {
        CMDIE_W::new(self, 14)
    }
    #[doc = "Bits 16:20 - transmit complete delay time"]
    #[inline(always)]
    ...
    #[doc = "Bit 26 - Receiver time out detection interrupt enable"]
    #[inline(always)]
    pub fn retodie(&mut self) -> RETODIE_W<'_, CTRL1_SPEC> {
