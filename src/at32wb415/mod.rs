...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            ...
            USB_OTG_GLOBAL: unsafe { USB_OTG_GLOBAL::steal() },
            USB_OTG_HOST: unsafe { USB_OTG_HOST::steal() },
            USB_OTG_DEVICE: unsafe { USB_OTG_DEVICE::steal() },
            USB_OTG_PWRCLK: unsafe { USB_OTG_PWRCLK::steal() },
        }
    }
}
