...
pub type HALLSWTR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type BRKSWTR_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    pub fn cswtr_iter(&self) -> impl Iterator<Item = CSWTR_R> + '_ {
        (0..2).map(move |n| CSWTR_R::new(((self.bits >> (n + 1)) & 1) != 0))
    }
...
impl crate::Writable for SWEVT_SPEC {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x47;
}
