...
#[doc = "Voltage regulator state select when deepsleep mode\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum VRSEL_A {
    #[doc = "0: LDO enabled in deepsleep mode"]
    Enabled = 0,
    #[doc = "1: LDO disabled in deepsleep mode"]
    Disabled = 1,
}
...
impl VRSEL_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> VRSEL_A {
        match self.bits {
            false => VRSEL_A::Enabled,
            true => VRSEL_A::Disabled,
        }
    }
    #[doc = "LDO enabled in deepsleep mode"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == VRSEL_A::Enabled
    }
    #[doc = "LDO disabled in deepsleep mode"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == VRSEL_A::Disabled
    }
}
#[doc = "Field `VRSEL` writer - Voltage regulator state select when deepsleep mode"]
pub type VRSEL_W<'a, REG> = crate::BitWriter<'a, REG, VRSEL_A>;
impl<'a, REG> VRSEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(VRSEL_A::Enabled)
    }
    #[doc = "LDO disabled in deepsleep mode"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(VRSEL_A::Disabled)
    }
}
#[doc = "Low power mode select when Cortex-M4 sleepdeep\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum LPSEL_A {
...
#[doc = "Battery power domain write enable\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BPWEN_A {
