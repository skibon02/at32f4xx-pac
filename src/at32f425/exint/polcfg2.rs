...
#[doc = "Field `FP(0-20)` reader - Falling polarity configuration bit on line %s"]
...
#[doc = "Field `FP(0-20)` writer - Falling polarity configuration bit on line %s"]
...
impl R {
    #[doc = "Falling polarity configuration bit on line (0-20)"]
    #[doc = ""]
    ...
    pub fn fp_iter(&self) -> impl Iterator<Item = FP_R> + '_ {
        (0..21).map(move |n| FP_R::new(((self.bits >> n) & 1) != 0))
    }
