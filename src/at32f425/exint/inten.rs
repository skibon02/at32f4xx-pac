...
#[doc = "Field `INTEN(0-20)` reader - Interrupt enable or disable on line %s"]
...
#[doc = "Field `INTEN(0-20)` writer - Interrupt enable or disable on line %s"]
...
impl R {
    #[doc = "Interrupt enable or disable on line (0-20)"]
    #[doc = ""]
    ...
    pub fn inten_iter(&self) -> impl Iterator<Item = INTEN_R> + '_ {
        (0..21).map(move |n| INTEN_R::new(((self.bits >> n) & 1) != 0))
    }
