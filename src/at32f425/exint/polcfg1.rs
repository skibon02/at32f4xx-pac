...
#[doc = "Field `RP(0-20)` reader - Rising polarity configuration bit on line %s"]
...
#[doc = "Field `RP(0-20)` writer - Rising polarity configuration bit on line %s"]
...
impl R {
    #[doc = "Rising polarity configuration bit on line (0-20)"]
    #[doc = ""]
    ...
    pub fn rp_iter(&self) -> impl Iterator<Item = RP_R> + '_ {
        (0..21).map(move |n| RP_R::new(((self.bits >> n) & 1) != 0))
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("POLCFG1")
            ...
            .field("rp18", &self.rp18())
            .field("rp19", &self.rp19())
            .field("rp20", &self.rp20())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 18 - Rising polarity configuration bit on line 18"]
    #[inline(always)]
    pub fn rp18(&mut self) -> RP_W<'_, POLCFG1_SPEC> {
        RP_W::new(self, 18)
    }
    #[doc = "Bit 19 - Rising polarity configuration bit on line 19"]
    #[inline(always)]
    pub fn rp19(&mut self) -> RP_W<'_, POLCFG1_SPEC> {
        RP_W::new(self, 19)
    }
    #[doc = "Bit 20 - Rising polarity configuration bit on line 20"]
    #[inline(always)]
    pub fn rp20(&mut self) -> RP_W<'_, POLCFG1_SPEC> {
        RP_W::new(self, 20)
    }
}
