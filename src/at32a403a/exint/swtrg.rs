...
#[doc = "Field `SWT(0-19)` reader - Software trigger on line %s"]
...
#[doc = "Field `SWT(0-19)` writer - Software trigger on line %s"]
...
impl R {
    #[doc = "Software trigger on line (0-19)"]
    #[doc = ""]
    ...
    pub fn swt_iter(&self) -> impl Iterator<Item = SWT_R> + '_ {
        (0..20).map(move |n| SWT_R::new(((self.bits >> n) & 1) != 0))
    }
