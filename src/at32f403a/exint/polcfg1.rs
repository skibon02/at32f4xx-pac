...
#[doc = "Field `RP(0-19)` reader - Rising polarity configuration bit on line %s"]
...
#[doc = "Field `RP(0-19)` writer - Rising polarity configuration bit on line %s"]
...
impl R {
    #[doc = "Rising polarity configuration bit on line (0-19)"]
    #[doc = ""]
    ...
    pub fn rp_iter(&self) -> impl Iterator<Item = RP_R> + '_ {
        (0..20).map(move |n| RP_R::new(((self.bits >> n) & 1) != 0))
    }
