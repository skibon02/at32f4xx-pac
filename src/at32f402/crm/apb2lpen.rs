...
#[doc = "Field `I2S5` reader - I2S5 clock enable during sleep mode"]
pub use TMR1_R as I2S5_R;
#[doc = "Field `ACC` reader - ACC clock enable during sleep mode"]
pub use TMR1_R as ACC_R;
#[doc = "Field `OTGHSPHY` reader - OTGHS phy clock enable during sleep mode"]
pub use TMR1_R as OTGHSPHY_R;
...
#[doc = "Field `I2S5` writer - I2S5 clock enable during sleep mode"]
pub use TMR1_W as I2S5_W;
#[doc = "Field `ACC` writer - ACC clock enable during sleep mode"]
pub use TMR1_W as ACC_W;
#[doc = "Field `OTGHSPHY` writer - OTGHS phy clock enable during sleep mode"]
pub use TMR1_W as OTGHSPHY_W;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB2LPEN")
            ...
            .field("i2s5", &self.i2s5())
            .field("acc", &self.acc())
            .field("otghsphy", &self.otghsphy())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 20 - I2S5 clock enable during sleep mode"]
    #[inline(always)]
    pub fn i2s5(&mut self) -> I2S5_W<'_, APB2LPEN_SPEC> {
        I2S5_W::new(self, 20)
    }
    #[doc = "Bit 29 - ACC clock enable during sleep mode"]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - OTGHS phy clock enable during sleep mode"]
    #[inline(always)]
    pub fn otghsphy(&mut self) -> OTGHSPHY_W<'_, APB2LPEN_SPEC> {
