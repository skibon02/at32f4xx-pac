...
#[doc = "Field `OTGHS` reader - OTGHS clock enable during sleep mode"]
...
#[doc = "Field `OTGHS` writer - OTGHS clock enable during sleep mode"]
...
impl W {
    ...
    #[doc = "Bit 29 - OTGHS clock enable during sleep mode"]
    #[inline(always)]
    pub fn otghs(&mut self) -> OTGHS_W<'_, AHBLPEN1_SPEC> {
        OTGHS_W::new(self, 29)
    }
}
