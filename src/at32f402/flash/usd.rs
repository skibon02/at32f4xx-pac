...
#[doc = "Field `nRAM_PRT_CHK` reader - SRAM parity check"]
pub type N_RAM_PRT_CHK_R = crate::BitReader;
...
impl R {
    ...
    #[doc = "Bit 9 - SRAM parity check"]
    #[inline(always)]
    pub fn n_ram_prt_chk(&self) -> N_RAM_PRT_CHK_R {
        N_RAM_PRT_CHK_R::new(((self.bits >> 9) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("USD")
            ...
            .field("n_ram_prt_chk", &self.n_ram_prt_chk())
