...
pub type HICKTRIM_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
impl R {
    ...
    #[doc = "Bits 3:7 - High speed internal clock trimming"]
    #[inline(always)]
    pub fn hicktrim(&self) -> HICKTRIM_R {
        HICKTRIM_R::new(((self.bits >> 3) & 0x1f) as u8)
    }
