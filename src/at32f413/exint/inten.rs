...
#[doc = "Field `INTEN(0-18)` reader - Interrupt enable or disable on line %s"]
...
#[doc = "Field `INTEN(0-18)` writer - Interrupt enable or disable on line %s"]
...
impl R {
    #[doc = "Interrupt enable or disable on line (0-18)"]
    #[doc = ""]
    ...
    pub fn inten_iter(&self) -> impl Iterator<Item = INTEN_R> + '_ {
        (0..19).map(move |n| INTEN_R::new(((self.bits >> n) & 1) != 0))
    }
