...
impl W {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `IOMC0` field.</div>"]
    #[inline(always)]
    pub fn iomc(&mut self, n: u8) -> IOMC_W<'_, CFGLR_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
        IOMC_W::new(self, n * 4)
    }
    #[doc = "Bits 0:1 - Port n.0 mode configurate bits"]
    #[inline(always)]
    pub fn iomc0(&mut self) -> IOMC_W<'_, CFGLR_SPEC> {
        IOMC_W::new(self, 0)
    }
    #[doc = "Bits 4:5 - Port n.1 mode configurate bits"]
    #[inline(always)]
    pub fn iomc1(&mut self) -> IOMC_W<'_, CFGLR_SPEC> {
        IOMC_W::new(self, 4)
    }
    #[doc = "Bits 8:9 - Port n.2 mode configurate bits"]
    #[inline(always)]
    pub fn iomc2(&mut self) -> IOMC_W<'_, CFGLR_SPEC> {
        IOMC_W::new(self, 8)
    }
    #[doc = "Bits 12:13 - Port n.3 mode configurate bits"]
    #[inline(always)]
    pub fn iomc3(&mut self) -> IOMC_W<'_, CFGLR_SPEC> {
        IOMC_W::new(self, 12)
    }
    #[doc = "Bits 16:17 - Port n.4 mode configurate bits"]
    #[inline(always)]
    pub fn iomc4(&mut self) -> IOMC_W<'_, CFGLR_SPEC> {
        IOMC_W::new(self, 16)
    }
    #[doc = "Bits 20:21 - Port n.5 mode configurate bits"]
    #[inline(always)]
    pub fn iomc5(&mut self) -> IOMC_W<'_, CFGLR_SPEC> {
        IOMC_W::new(self, 20)
    }
    #[doc = "Bits 24:25 - Port n.6 mode configurate bits"]
    #[inline(always)]
    pub fn iomc6(&mut self) -> IOMC_W<'_, CFGLR_SPEC> {
        IOMC_W::new(self, 24)
    }
    #[doc = "Bits 28:29 - Port n.7 mode configurate bits"]
    #[inline(always)]
    pub fn iomc7(&mut self) -> IOMC_W<'_, CFGLR_SPEC> {
        IOMC_W::new(self, 28)
    }
    #[doc = "Port n.(0-7) function configurate bits"]
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `IOFC0` field.</div>"]
    #[inline(always)]
    pub fn iofc(&mut self, n: u8) -> IOFC_W<'_, CFGLR_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[doc = "Bits 2:3 - Port n.0 function configurate bits"]
    #[inline(always)]
    pub fn iofc0(&mut self) -> IOFC_W<'_, CFGLR_SPEC> {
        IOFC_W::new(self, 2)
    }
    #[doc = "Bits 6:7 - Port n.1 function configurate bits"]
    #[inline(always)]
    pub fn iofc1(&mut self) -> IOFC_W<'_, CFGLR_SPEC> {
        IOFC_W::new(self, 6)
    }
    #[doc = "Bits 10:11 - Port n.2 function configurate bits"]
    #[inline(always)]
    pub fn iofc2(&mut self) -> IOFC_W<'_, CFGLR_SPEC> {
        IOFC_W::new(self, 10)
    }
    #[doc = "Bits 14:15 - Port n.3 function configurate bits"]
    #[inline(always)]
    pub fn iofc3(&mut self) -> IOFC_W<'_, CFGLR_SPEC> {
        IOFC_W::new(self, 14)
    }
    #[doc = "Bits 18:19 - Port n.4 function configurate bits"]
    #[inline(always)]
    pub fn iofc4(&mut self) -> IOFC_W<'_, CFGLR_SPEC> {
        IOFC_W::new(self, 18)
    }
    #[doc = "Bits 22:23 - Port n.5 function configurate bits"]
    #[inline(always)]
    pub fn iofc5(&mut self) -> IOFC_W<'_, CFGLR_SPEC> {
        IOFC_W::new(self, 22)
    }
    #[doc = "Bits 26:27 - Port n.6 function configurate bits"]
    #[inline(always)]
    pub fn iofc6(&mut self) -> IOFC_W<'_, CFGLR_SPEC> {
        IOFC_W::new(self, 26)
    }
    #[doc = "Bits 30:31 - Port n.7 function configurate bits"]
    #[inline(always)]
    pub fn iofc7(&mut self) -> IOFC_W<'_, CFGLR_SPEC> {
        IOFC_W::new(self, 30)
    }
}
